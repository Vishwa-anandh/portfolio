...
export function ToolsKnown() {
  const tools = [
    ...
    { name: "Figma", src: "/logos/figma-logo-svg-150px.png", colors: ["#F24E1E", "#FF7262", "#A259FF", "#1ABCFE", "#0ACF83"] },
    ...
    { name: "Google Labs", src: "/logos/google labs.png", colors: ["#ffffff", "#aaaaaa"] },
    { name: "Google Analytics", src: "/logos/google-analytics-logo-svg-150px.png", colors: ["#E37400", "#F9AB00"] },
    { name: "Search Console", src: "/logos/google-search-console-logo-svg-150px.png", colors: ["#4285F4", "#8AB4F8"] },
  ...
  return (
    <section className="relative w-full mx-auto mb-20 max-w-[1400px] px-4 md:px-8" id="tools">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 border-l border-t border-white/10 bg-[#0a0a0a]/40 shadow-2xl">
        {tools.map(renderLogo)}
      </div>
    </section>
  );
}
