...
export function ToolsKnown() {
  const tools = [
    ...
    { name: "Figma", src: "/logos/figma-logo-svg-150px.png", colors: ["#F24E1E", "#A259FF", "#1ABCFE", "#0ACF83"] },
    ...
    { name: "Google Search Console", src: "/logos/google-search-console-logo-svg-150px.png", colors: ["#4285F4", "#8AB4F8"] },
  ];
