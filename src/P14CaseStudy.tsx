  ...
  return (
    <div className={`relative w-full max-w-[1240px] mx-auto mt-0 md:mt-4 ${className}`} style={{ perspective: "2000px" }}>
      ...
      >
        ...
        <div 
          className="relative rounded-[1rem] md:rounded-[1.5rem] overflow-hidden bg-neutral-900 border border-white/5 flex flex-col z-10"
          style={{
        ...
        >
          ...
          <div className="relative w-full aspect-[16/10] md:aspect-[16/9] bg-neutral-950 overflow-hidden">
             {children}
          </div>
        </div>
      </motion.div>
...
function ZoomableImage({ src, alt, onClick, className = "" }: { src: string, alt: string, onClick: (src: string, alt: string) => void, className?: string }) {
  return (
    <motion.div 
      ...
      whileTap={{ scale: 0.98 }}
      className={`relative group cursor-zoom-in overflow-hidden shadow-lg bg-neutral-800 border border-white/5 ${className || "rounded-xl"}`}
...
function SoftBackground() {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-[-1]">
      ...
      {/* Static Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full pointer-events-none blur-[120px] opacity-20 opacity-10 bg-[radial-gradient(circle,rgba(99,102,241,0.1)_0%,rgba(168,85,247,0.05)_40%,transparent_60%)]" />
    </div>
  );
}
...
export default function P14CaseStudy({ project: _project }: { project: Project }) {
  ...
  return (
    <>
      ...
      <div className="case-study-shell w-full bg-neutral-900/40 backdrop-blur-3xl border border-white/5 text-white/80 font-sans mt-8 pt-12 lg:pt-24 rounded-[3rem] px-4 sm:px-6 lg:px-8 xl:px-10 mb-12 shadow-xl shadow-black/50 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          >
            <motion.div variants={itemVariants} className="w-full">
              <div className="inline-block px-4 py-1.5 rounded-full border border-indigo-500/20 bg-indigo-500/100/10 text-indigo-400 text-xs font-mono uppercase tracking-widest mb-6">SaaS Application</div>
              <h1 className="text-5xl md:text-7xl font-sans tracking-tight font-medium text-white mb-6 bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-violet-600 from-indigo-400 to-violet-400">P14 WorkOS</h1>
              ...
              <div className="flex flex-wrap gap-8 md:gap-16 pt-8 border-t border-white/5">
                ...
                <div>
                  <p className="text-xs uppercase tracking-widest text-white/50 mb-2 font-mono">Competencies</p>
                  <div className="flex flex-wrap gap-3 mt-1">
                    <span className="px-3 py-1 rounded-full bg-neutral-900/5 border border-white/5 text-sm">Product UI</span>
                    <span className="px-3 py-1 rounded-full bg-neutral-900/5 border border-white/5 text-sm">AI Interfaces</span>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={containerVariants} className="mb-32">
            <motion.h3 variants={itemVariants} className="text-sm font-mono text-indigo-400 uppercase tracking-widest mb-16 inline-block pb-2 border-b border-indigo-500/30">01 // The Approach</motion.h3>
            
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 text-left group">
              <div className="col-span-1 md:col-span-4">
                <h4 className="text-2xl font-light text-white transition-colors">Unified Command Center</h4>
              </div>
          ...
          {/* Core Features */}
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={containerVariants} className="mb-32">
            <motion.h3 variants={itemVariants} className="text-sm font-mono text-indigo-400 uppercase tracking-widest mb-16 inline-block pb-2 border-b border-indigo-500/30">02 // Key Pillars</motion.h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <motion.div variants={itemVariants} className="p-8 rounded-2xl bg-neutral-900/60 border border-white/5 hover:bg-neutral-900 hover:bg-neutral-800 transition-all duration-300">
                 <div className="w-12 h-12 rounded-xl bg-indigo-500/100/10 text-indigo-400 flex items-center justify-center mb-6 text-xl font-mono">01</div>
                 <h4 className="text-xl font-medium text-white mb-4">Granular Management</h4>
                 <p className="text-white/60 font-light leading-relaxed">Streamlined modals and views for project and task creation. Clean inputs, clear hierarchies, and integrated status trackers give teams an eagle-eye view of progress.</p>
              </motion.div>
              <motion.div variants={itemVariants} className="p-8 rounded-2xl bg-neutral-900/60 border border-white/5 hover:bg-neutral-900 hover:bg-neutral-800 transition-all duration-300">
                 <div className="w-12 h-12 rounded-xl bg-indigo-500/100/10 text-indigo-400 flex items-center justify-center mb-6 text-xl font-mono">02</div>
                 <h4 className="text-xl font-medium text-white mb-4">Omnipresent AI Agent</h4>
                 <p className="text-white/60 font-light leading-relaxed">An ever-ready conversational assistant that summarizes threads, calculates risk deadlines, and drafts project communications directly within the dashboard context.</p>
              </motion.div>
              <motion.div variants={itemVariants} className="p-8 rounded-2xl bg-neutral-900/60 border border-white/5 hover:bg-neutral-900 hover:bg-neutral-800 transition-all duration-300">
                 <div className="w-12 h-12 rounded-xl bg-indigo-500/100/10 text-indigo-400 flex items-center justify-center mb-6 text-xl font-mono">03</div>
                 <h4 className="text-xl font-medium text-white mb-4">Native Communications</h4>
                 <p className="text-white/60 font-light leading-relaxed">Reducing app-switching by weaving inboxes, direct messaging, and video conferencing directly into the workflow canvas for fluid remote collaboration.</p>
              </motion.div>
            </div>
          </motion.div>
          ...
          <div className="mb-32">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={containerVariants} className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
              <div>
                <motion.h3 variants={itemVariants} className="text-sm font-mono text-indigo-400 uppercase tracking-widest inline-block pb-2 border-b border-indigo-500/30">03 // Functional Views</motion.h3>
                <motion.h2 variants={itemVariants} className="text-4xl text-white font-light mt-8">Dashboard Layouts</motion.h2>
              </div>
            ...
            <div className="space-y-32">
                ...
                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={containerVariants}>
                   <div className="flex items-center gap-4 mb-12">
                     ...
                     <h4 className="text-xl font-medium text-indigo-400 px-4 font-mono">1 / App Fundamentals</h4>
                     <div className="h-[1px] bg-neutral-900/10 flex-grow" />
                  </div>
                ...
                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={containerVariants}>
                   <div className="flex items-center gap-4 mb-12">
                     <div className="h-[1px] bg-neutral-900/10 flex-grow" />
                     <h4 className="text-xl font-medium text-indigo-400 px-4 font-mono">2 / Workflow Authoring</h4>
                     <div className="h-[1px] bg-neutral-900/10 flex-grow" />
                  </div>
                ...
                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={containerVariants}>
                   <div className="flex items-center gap-4 mb-12">
                     <div className="h-[1px] bg-neutral-900/10 flex-grow" />
                     <h4 className="text-xl font-medium text-indigo-400 px-4 font-mono">3 / AI & Connectivity</h4>
                     <div className="h-[1px] bg-neutral-900/10 flex-grow" />
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={containerVariants}>
                   <div className="flex items-center gap-4 mb-12">
                     <div className="h-[1px] bg-neutral-900/10 flex-grow" />
                     <h4 className="text-xl font-medium text-indigo-400 px-4 font-mono">4 / Access & Account Controls</h4>
                     <div className="h-[1px] bg-neutral-900/10 flex-grow" />
                  </div>
           ...
           <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={containerVariants} className="py-24 text-center border-t border-white/5 bg-gradient-to-t from-white/5 from-white/5 to-transparent rounded-b-[3rem] px-4 -mx-4 sm:-mx-6 lg:-mx-8 xl:-mx-10 -mb-12">
              <motion.h2 variants={itemVariants} className="text-4xl md:text-5xl text-white font-sans tracking-tight mb-6 font-medium">EXPLORATION COMPLETE</motion.h2>
              <motion.p variants={itemVariants} className="text-white/50 font-light text-lg">Thank you for reviewing the P14 AI Dashboard layout concepts.</motion.p>
           </motion.div>
        </div>
      </div>
