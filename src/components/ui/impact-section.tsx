      ...
      <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8">
        <div className="flex items-start justify-between gap-6 mb-8 sm:mb-12">
          ...
          <div className="hidden md:flex items-center">
            <Link
              to="/projects"
              className="flex items-center gap-2 text-white/50 hover:text-white transition-colors font-mono uppercase tracking-wider text-sm underline-offset-4 hover:underline"
            >
        ...
        <div className="flex flex-row md:items-end gap-3 md:gap-0 overflow-x-auto md:overflow-visible pb-4 md:pb-0 snap-x hide-scrollbar">
          {projects.map((project, idx) => {
            ...
            return (
              ...
              >
                ...
                >
                  {isOpen ? (
                    <div className="h-full p-6 sm:p-8 flex flex-col justify-between w-[280px] sm:w-[320px] md:w-[400px]">
