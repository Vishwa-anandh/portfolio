  ...
  return (
    <div className={`relative w-full max-w-[1000px] mx-auto mt-0 md:mt-4 ${className}`} style={{ perspective: "2500px" }}>
      ...
      >
        ...
        {/* Main Desktop Window */}
        <div 
          className="relative rounded-xl md:rounded-[1.25rem] overflow-hidden bg-neutral-950 border border-white/10 border-white/5 flex flex-col z-10 w-[90%] md:w-[85%] ml-0 md:ml-4"
          style={{
        ...
        >
          ...
          <div className="h-8 md:h-10 border-b border-white/5 bg-[#f9f9f9] dark:bg-[#111] flex items-center px-4 gap-2">
            <div className="w-2.5 h-2.5 md:w-3 md:h-3 rounded-full bg-black/10 dark:bg-neutral-900/10"></div>
            <div className="w-2.5 h-2.5 md:w-3 md:h-3 rounded-full bg-black/10 dark:bg-neutral-900/10"></div>
            <div className="w-2.5 h-2.5 md:w-3 md:h-3 rounded-full bg-black/10 dark:bg-neutral-900/10"></div>
          </div>

          <div className="relative w-full aspect-[16/10] bg-neutral-900 group">
             <img src={desktopSrc} alt="Desktop View" loading="eager" decoding="async" fetchPriority="high" onClick={onDesktopClick} className="absolute inset-0 w-full h-full object-cover object-left-top cursor-zoom-in" />
        ...
        <motion.div 
          className="absolute -right-2 -bottom-6 md:-right-8 md:-bottom-12 w-[35%] md:w-[28%] min-w-[140px] max-w-[280px] rounded-[1.75rem] md:rounded-[2.5rem] overflow-hidden bg-neutral-950 border-[6px] md:border-[10px] border-neutral-200 dark:border-neutral-800 z-20 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.6)]"
          style={{ 
            x: mobileX, 
            y: mobileY,
        ...
        >
           ...
           <div className="relative w-full aspect-[9/19.5] bg-neutral-900 group">
             <img src={mobileSrc} alt="Mobile View" loading="lazy" decoding="async" fetchPriority="low" onClick={onMobileClick} className="w-full h-full object-cover object-top cursor-zoom-in" />
             <div className="absolute inset-0 bg-black/0 group-hover:bg-neutral-900/5 transition-colors duration-300 pointer-events-none" />
...
function ModernBackground() {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0 mix-blend-screen">
      {/* Subtle Grid */}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(0,0,0,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,0.03)_1px,transparent_1px)] dark:bg-[linear-gradient(rgba(0,0,0,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,0.03)_1px,transparent_1px)] bg-[size:64px_64px] [mask-image:radial-gradient(ellipse_100%_100%_at_50%_50%,#000_10%,transparent_80%)] opacity-70" />
...
export default function EducourseCaseStudy({ project }: { project: Project }) {
  ...
  return (
    <>
      ...
      <div className="case-study-shell w-full bg-neutral-900/5 bg-neutral-950/80 backdrop-blur-xl border border-white/5 text-white/80 font-sans mt-8 pt-12 lg:pt-24 rounded-[3rem] px-4 sm:px-6 lg:px-8 xl:px-10 mb-12 shadow-xl shadow-black/50 dark:shadow-[0_0_80px_-20px_rgba(0,0,0,0.05)] relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          >
            <motion.div variants={itemVariants} className="w-full">
              <div className="inline-block px-4 py-1.5 rounded-full border border-indigo-600/30 bg-indigo-800/10 dark:bg-indigo-800/20 text-indigo-400 dark:text-indigo-300 text-xs font-mono uppercase tracking-widest mb-6">Case Study</div>
              <h1 className="text-5xl md:text-7xl font-sans tracking-tighter text-white mb-6 bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 via-purple-500 to-indigo-500 dark:from-indigo-100 dark:via-purple-200 dark:to-indigo-500">{project.name}</h1>
              ...
              <div className="flex flex-wrap gap-8 md:gap-16 pt-8 border-t border-white/5">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-3 mt-1">
                    <span className="px-3 py-1 rounded-full bg-neutral-900/5 bg-neutral-900/5 border border-white/5 text-sm text-neutral-700 dark:text-white/80">Figma</span>
                    <span className="px-3 py-1 rounded-full bg-neutral-900/5 bg-neutral-900/5 border border-white/5 text-sm text-neutral-700 dark:text-white/80">UI/UX Design</span>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={containerVariants} className="mb-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 text-left group">
              <div className="col-span-1 md:col-span-4">
                <h4 className="text-2xl font-light text-white group-hover:text-indigo-500 dark:group-hover:text-indigo-400 transition-colors">Empowering Creators</h4>
              </div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={containerVariants} className="mb-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <motion.div variants={itemVariants} className="p-8 rounded-3xl bg-neutral-900 shadow-lg shadow-black/50 border border-white/5 hover:bg-neutral-900 dark:hover:bg-neutral-900 hover:border-indigo-500/20 transition-all duration-300">
                 <div className="w-12 h-12 rounded-xl bg-neutral-900/5 bg-neutral-900/5 text-indigo-400 dark:text-indigo-300 flex items-center justify-center mb-6 text-xl">01</div>
                 <h4 className="text-xl font-medium text-white mb-4">AI-Driven Creation</h4>
                 <p className="text-white/60 font-light leading-relaxed">Integrated AI assistant helps creators structure their curriculum, draft lesson content, and automatically generate quizzes and knowledge checks to accelerate the course building process.</p>
              </motion.div>
              <motion.div variants={itemVariants} className="p-8 rounded-3xl bg-neutral-900 shadow-lg shadow-black/50 border border-white/5 hover:bg-neutral-900 dark:hover:bg-neutral-900 hover:border-indigo-500/20 transition-all duration-300">
                 <div className="w-12 h-12 rounded-xl bg-neutral-900/5 bg-neutral-900/5 text-indigo-400 dark:text-indigo-300 flex items-center justify-center mb-6 text-xl">02</div>
                 <h4 className="text-xl font-medium text-white mb-4">Communities & Coaching</h4>
                 <p className="text-white/60 font-light leading-relaxed">Beyond passive video courses, the platform offers integrated social feeds, community groups, and 1-on-1 coaching scheduling to create high-value hybrid learning experiences.</p>
              </motion.div>
              <motion.div variants={itemVariants} className="p-8 rounded-3xl bg-neutral-900 shadow-lg shadow-black/50 border border-white/5 hover:bg-neutral-900 dark:hover:bg-neutral-900 hover:border-indigo-500/20 transition-all duration-300">
                 <div className="w-12 h-12 rounded-xl bg-neutral-900/5 bg-neutral-900/5 text-indigo-400 dark:text-indigo-300 flex items-center justify-center mb-6 text-xl">03</div>
                 <h4 className="text-xl font-medium text-white mb-4">Robust Analytics</h4>
                 <p className="text-white/60 font-light leading-relaxed">Detailed dashboards provide immediate visibility into course sales, student progress, engagement metrics, and revenue tracking across web and mobile platforms.</p>
              </motion.div>
            </div>
          </motion.div>
          ...
          <div className="mb-32">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={containerVariants} className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
              <div>
                ...
                <motion.h2 variants={itemVariants} className="text-4xl text-white font-light mt-8">Platform Interfaces</motion.h2>
              </div>
            ...
            <div className="space-y-32">
                ...
                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={containerVariants}>
                   <div className="flex items-center gap-4 mb-12">
                     ...
                     <h4 className="text-xl font-medium text-indigo-400 dark:text-indigo-300 px-4 font-mono">1 / Dashboards & Reporting</h4>
                     <div className="h-[1px] bg-indigo-500/100/10 flex-grow" />
                  </div>
                ...
                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={containerVariants}>
                   <div className="flex items-center gap-4 mb-12">
                     <div className="h-[1px] bg-indigo-500/100/10 flex-grow" />
                     <h4 className="text-xl font-medium text-indigo-400 dark:text-indigo-300 px-4 font-mono">2 / Course Builder & Curriculum</h4>
                     <div className="h-[1px] bg-indigo-500/100/10 flex-grow" />
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={containerVariants}>
                   <div className="flex items-center gap-4 mb-12">
                     <div className="h-[1px] bg-indigo-500/100/10 flex-grow" />
                     <h4 className="text-xl font-medium text-indigo-400 dark:text-indigo-300 px-4 font-mono">3 / Coaching & Community</h4>
                     <div className="h-[1px] bg-indigo-500/100/10 flex-grow" />
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={containerVariants}>
                   <div className="flex items-center gap-4 mb-12">
                     <div className="h-[1px] bg-indigo-500/100/10 flex-grow" />
                     <h4 className="text-xl font-medium text-indigo-400 dark:text-indigo-300 px-4 font-mono">4 / Engagement & Growth</h4>
                     <div className="h-[1px] bg-indigo-500/100/10 flex-grow" />
                  </div>
                ...
                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={containerVariants}>
                   <div className="flex items-center gap-4 mb-12">
                     <div className="h-[1px] bg-indigo-500/100/10 flex-grow" />
                     <h4 className="text-xl font-medium text-indigo-400 dark:text-indigo-300 px-4 font-mono">5 / Mobile Experience</h4>
                     <div className="h-[1px] bg-indigo-500/100/10 flex-grow" />
                  </div>
                  <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
                    <ZoomableImage src="/Educourse - AI for Online Course/Home Page - Mobile.png" alt="Mobile Dashboard" onClick={openImage} className="rounded-3xl border border-white/10 border-white/5" />
                    <ZoomableImage src="/Educourse - AI for Online Course/Analystics - Mobile.png" alt="Mobile Analytics" onClick={openImage} className="rounded-3xl border border-white/10 border-white/5" />
                    <ZoomableImage src="/Educourse - AI for Online Course/Create Courses - Mobile.png" alt="Mobile Create Course" onClick={openImage} className="rounded-3xl border border-white/10 border-white/5" />
                    <ZoomableImage src="/Educourse - AI for Online Course/Curriculum Page - Mobile.png" alt="Mobile Curriculum" onClick={openImage} className="rounded-3xl border border-white/10 border-white/5" />
                    <ZoomableImage src="/Educourse - AI for Online Course/Coaching Page - Mobile.png" alt="Mobile Coaching" onClick={openImage} className="rounded-3xl border border-white/10 border-white/5" />
                    <ZoomableImage src="/Educourse - AI for Online Course/Community Details - Mobile.png" alt="Mobile Community" onClick={openImage} className="rounded-3xl border border-white/10 border-white/5" />
                    <ZoomableImage src="/Educourse - AI for Online Course/Create New Podcast - Mobile.png" alt="Mobile Podcast" onClick={openImage} className="rounded-3xl border border-white/10 border-white/5" />
                    <ZoomableImage src="/Educourse - AI for Online Course/Create Certificate - Mobile.png" alt="Mobile Certificate" onClick={openImage} className="rounded-3xl border border-white/10 border-white/5" />
                  </div>
                </motion.div>
           ...
           <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={containerVariants} className="py-24 text-center border-t border-white/5 bg-gradient-to-t from-white/5 from-white/5 to-transparent rounded-b-[3rem] px-4 -mx-4 sm:-mx-6 lg:-mx-8 xl:-mx-10 -mb-12">
              <motion.h2 variants={itemVariants} className="text-4xl md:text-5xl text-white font-sans tracking-tight mb-6">EXPLORATION COMPLETE</motion.h2>
              <motion.p variants={itemVariants} className="text-white/50 font-light text-lg">Thank you for reviewing the Educourse case study.</motion.p>
           </motion.div>
        </div>
      </div>
