...
import {
  BackControl,
  NextProjectLink,
} from "./components/ui/site-controls";
...
export default function ProjectDetail() {
  ...
  if (project.id === 9) {
    return (
      <div className="min-h-screen bg-black font-sans w-full pb-24 text-neutral-300">
        {projectSeo}
        
        <div className="relative z-50 w-full px-4 pt-12 sm:px-6 lg:px-10 xl:px-12">
          <BackControl fallback="/projects" className="mb-8" />
          <PulseCXCaseStudy project={project} />
          
          <NextProjectLink to="/projects/0" name="Workflow AI" />
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-black font-sans w-full pb-24 text-neutral-300">
        ...
        <div className="relative z-50 w-full px-4 pt-12 sm:px-6 lg:px-10 xl:px-12">
          ...
          <NextProjectLink to="/projects/1" name="SEO PRO" />
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-black font-sans w-full pb-24 text-neutral-300">
        ...
        <div className="relative z-50 w-full px-4 pt-12 sm:px-6 lg:px-10 xl:px-12">
          ...
          <NextProjectLink to="/projects/2" name="Agentic14" />
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-black font-sans w-full pb-24 text-neutral-300">
        ...
        <div className="relative z-50 w-full px-4 pt-12 sm:px-6 lg:px-10 xl:px-12">
          ...
          <NextProjectLink to="/projects/3" name="Payroll System" />
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-black font-sans w-full pb-24 text-neutral-300">
        ...
        <div className="relative z-50 w-full px-4 pt-12 sm:px-6 lg:px-10 xl:px-12">
          ...
          <NextProjectLink to="/projects/4" name="Educourse" />
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-black font-sans w-full pb-24 text-neutral-300">
        ...
        <div className="relative z-50 w-full px-4 pt-12 sm:px-6 lg:px-10 xl:px-12">
          ...
          <NextProjectLink to="/projects/5" name="Loop HR" />
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-black font-sans w-full pb-24 text-neutral-300">
        ...
        <div className="relative z-50 w-full px-4 pt-12 sm:px-6 lg:px-10 xl:px-12">
          ...
          <NextProjectLink to="/projects/6" name="SmartyAir" />
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-black font-sans w-full pb-24 text-neutral-300">
        ...
        <div className="relative z-50 w-full px-4 pt-12 sm:px-6 lg:px-10 xl:px-12">
          ...
          <NextProjectLink to="/projects/7" name="P14 Dashboard" />
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-black font-sans w-full pb-24 text-neutral-300">
        ...
        <div className="relative z-50 w-full px-4 pt-12 sm:px-6 lg:px-10 xl:px-12">
          ...
          <NextProjectLink to="/projects/9" name="PulseCX" />
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-[#111111] dark:bg-[#111111] font-sans w-full text-white">
        ...
        <div className="w-full relative z-50">
          <BackControl fallback="/projects" className="fixed left-6 top-6 z-50" />
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans w-full">
      {projectSeo}
      <div className="w-full px-4 py-12 sm:px-6 md:py-24 lg:px-10 xl:px-12">
        {/* Header */}
        ...
        <NextProjectLink
          ...
          name={projects[project.id >= projects.length ? 0 : project.id]?.name || "View Next"}
        />
      </div>
    </div>
  );
