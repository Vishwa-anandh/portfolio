  ...
  return (
    <div className={`relative w-full max-w-[800px] mx-auto mt-0 md:mt-4 flex justify-center ${className}`} style={{ perspective: "2500px" }}>
      ...
      >
        ...
        {/* Main Mobile Window */}
        <div 
          className="relative w-[50%] md:w-[45%] min-w-[200px] max-w-[320px] rounded-[2rem] md:rounded-[3rem] overflow-hidden bg-neutral-950 border-[8px] md:border-[12px] border-neutral-200 dark:border-neutral-800 z-10 mr-12 md:mr-24"
          style={{
        ...
        <motion.div 
          className="absolute right-[5%] md:right-[15%] top-[10%] w-[45%] md:w-[40%] min-w-[180px] max-w-[300px] rounded-[1.75rem] md:rounded-[2.5rem] overflow-hidden bg-neutral-950 border-[6px] md:border-[10px] border-neutral-200 dark:border-neutral-800 z-20 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.6)]"
          style={{ 
            x: secondaryX, 
            y: secondaryY,
...
function ZoomableImage({ src, alt, onClick, className = "" }: { src: string, alt: string, onClick: (src: string, alt: string) => void, className?: string }) {
  return (
    <motion.div 
      ...
      whileTap={{ scale: 0.98 }}
      className={`relative group cursor-zoom-in overflow-hidden shadow-xl shadow-black/50 bg-neutral-900 shadow-lg shadow-black/50 ${className || "rounded-3xl border border-white/5"}`}
        ...
        <div className="relative z-10">
          ...
          >
            <motion.div variants={itemVariants} className="w-full">
              ...
              <h1 className="text-5xl md:text-7xl font-sans tracking-tighter text-white mb-6 bg-clip-text text-transparent bg-gradient-to-r from-teal-500 via-emerald-500 to-teal-500 dark:from-teal-200 dark:via-emerald-200 dark:to-teal-400">{project.name}</h1>
              ...
              <div className="flex flex-wrap gap-8 md:gap-16 pt-8 border-t border-white/5">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-3 mt-1">
                    ...
                    <span className="px-3 py-1 rounded-full bg-neutral-900/5 bg-neutral-900/5 border border-white/5 text-sm text-neutral-700 dark:text-white/80">Mobile UI/UX</span>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={containerVariants} className="mb-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 text-left group">
              <div className="col-span-1 md:col-span-4">
                <h4 className="text-2xl font-light text-white group-hover:text-teal-600 dark:group-hover:text-teal-400 transition-colors">Frictionless HR</h4>
              </div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={containerVariants} className="mb-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <motion.div variants={itemVariants} className="p-8 rounded-3xl bg-neutral-900 shadow-lg shadow-black/50 border border-white/5 hover:bg-neutral-900 dark:hover:bg-neutral-900 hover:border-teal-500/20 transition-all duration-300">
                 <div className="w-12 h-12 rounded-xl bg-neutral-900/5 bg-neutral-900/5 text-teal-600 dark:text-teal-400 flex items-center justify-center mb-6 text-xl">01</div>
                 <h4 className="text-xl font-medium text-white mb-4">Intelligent Attendance</h4>
                 <p className="text-white/60 font-light leading-relaxed">By shifting from a standard button-tap checkout to multi-factor verifications including GPS geofencing and facial recognition, ensuring robust data precision seamlessly.</p>
              </motion.div>
              <motion.div variants={itemVariants} className="p-8 rounded-3xl bg-neutral-900 shadow-lg shadow-black/50 border border-white/5 hover:bg-neutral-900 dark:hover:bg-neutral-900 hover:border-teal-500/20 transition-all duration-300">
                 <div className="w-12 h-12 rounded-xl bg-neutral-900/5 bg-neutral-900/5 text-teal-600 dark:text-teal-400 flex items-center justify-center mb-6 text-xl">02</div>
                 <h4 className="text-xl font-medium text-white mb-4">AI-Backed Guidance</h4>
                 <p className="text-white/60 font-light leading-relaxed">Integrated a conversational AI bot to instantly resolve policy questions, guide expense claims, and act as a persistent digital HR assistant inside the employee's pocket.</p>
              </motion.div>
              <motion.div variants={itemVariants} className="p-8 rounded-3xl bg-neutral-900 shadow-lg shadow-black/50 border border-white/5 hover:bg-neutral-900 dark:hover:bg-neutral-900 hover:border-teal-500/20 transition-all duration-300">
                 <div className="w-12 h-12 rounded-xl bg-neutral-900/5 bg-neutral-900/5 text-teal-600 dark:text-teal-400 flex items-center justify-center mb-6 text-xl">03</div>
                 <h4 className="text-xl font-medium text-white mb-4">Unified Management Center</h4>
                 <p className="text-white/60 font-light leading-relaxed">Aggregated separated workflows (Payslips, Expenses, Leaves, Approvals) into single, highly scannable profile and action centers with streamlined request forms.</p>
              </motion.div>
            </div>
          </motion.div>
          ...
          <div className="mb-32">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={containerVariants} className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
              <div>
                ...
                <motion.h2 variants={itemVariants} className="text-4xl text-white font-light mt-8">App Modules Gallery</motion.h2>
              </div>
           ...
           <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={containerVariants} className="py-24 text-center border-t border-white/5 bg-gradient-to-t from-white/5 from-white/5 to-transparent rounded-b-[3rem] px-4 -mx-4 sm:-mx-6 lg:-mx-8 xl:-mx-10 -mb-12">
              ...
              <motion.p variants={itemVariants} className="text-white/50 font-light text-lg">Thank you for reviewing the Loop HR integration study.</motion.p>
           </motion.div>
        </div>
      </div>
